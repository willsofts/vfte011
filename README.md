...
2. api try out, this is supported api that you have created ex. \
    curl -X POST http://localhost:8080/api/sfte011/list

This vue application using `sfte011` api to manipulate transaction. \
...
### Testing
1. Normally copy output folder after build success ex. vfte011 into [vueserve](https://github.com/willsofts/vueserve) project under public path and then you can launch it directly ex. 

    http://localhost:8080/vfte011/vfte011.html
