...
<div id="searchpanel" class="panel-body search-panel">
    <div class="row row-height">
        <div class="col-height col-md-3">
            <label for="account">{{ labels.reservenums_label }}</label>
            <input type="text" v-model="localData.reservenum" class="form-control input-md" maxlength="50" />
        </div>
...
const tableSettings = {
    ...
    columns: [
      {name: "reservenum", type: "STRING", sorter: "reservenum", label: "reservenum_headerlabel" },
        {name: "remarks", type: "STRING", sorter: "remarks", label: "remarks_headerlabel" },
    ],        
    actions: [
